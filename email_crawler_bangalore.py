...
import re, urlparse
import traceback
from databasebangalore import CrawlerDb
...
def getHostName(url2):
	url = urlparse.urlparse(url2)
...
def crawl(keywords):
	...
	# 	results = google_search(keywords, my_api_key, my_cse_id, num=10,start=i)
	# 	for result in results:
	# 		print result['link']
	# 		db.enqueue(unicode(result['link']))
